...
saveRDS(data.nonempty, "../inst/extdata/pbmc1k_seurat_nonempty.rds")
...
file_paths <- c("../inst/extdata/pbmc1k_seurat_filtered.rds", "../inst/extdata/pbmc1k_seurat_nonempty.rds", "../inst/extdata/pbmc1k_seurat_tcell.rds")
...
```{r}
fom(result,"fom1","representation") <-"example"
```
...
```{r}
write_MAMS_to_JSON(MAMS=result, filepath = "../inst/extdata/pbmc1k_rna_adt_seurat_mams.json")
```
